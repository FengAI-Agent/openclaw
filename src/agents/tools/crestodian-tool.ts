...
export function createCrestodianTool(options: CrestodianToolOptions): AnyAgentTool {
  return {
    ...
    description: [
      ...
      "connect_channel(channel) starts guided channel setup in this chat; open_agent hands off to the normal agent; open_setup hands off to a menu wizard. All run immediately.",
